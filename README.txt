...
ans. Currently the Islam Companion plugin displays a random verse from the Holy Quran at the top of the admin page. The verse is displayed in the language selected by the user. For each day a new verse is displayed.
